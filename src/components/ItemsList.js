        ...
        <div className='row g-4'>
            {props.items.map((item, idx) => {
                return <div className='col-lg-3 col-md-4 col-6' key={idx}>
                    <Card>
                        <div className='card-header p-0 border-0 border-bottom' onClick={detailProduct(item.sku)}>
                        ...
                        <div className='card-body px-3 border-0'>
                            ...
                            <div className='d-flex'>
                                ...
                                {item.price_range.minimum_price.discount.percent_off != 0 ? <p className='ms-2 text-decoration-line-through mb-0 opacity-75'>฿{item.price_range.minimum_price.regular_price.value}</p> : ''}
                            </div>
